...
bool ShaderProgram::CompileAndLink( void )
{
	...
	// �bergebene Textdateien einlesen und pr�fen ob diese nicht leer sind.
...
void ShaderProgram::ViewMatrixSet( glm::mat4 & view )
{
	glUniformMatrix4fv( locView, 1, GL_FALSE, glm::value_ptr( view ) );
}

void ShaderProgram::ProjectionMatrixSet( glm::mat4 & projection )
{
